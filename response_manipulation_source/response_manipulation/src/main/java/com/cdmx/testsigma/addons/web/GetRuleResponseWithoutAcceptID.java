...
/*Change Log: General Task | Function to Generate the rule response Without AcceptID and store it in a runtime variable | 16/11/23 */
...
@Data
@Action(actionText = "Generate the rule response without AcceptID from (rule_id testdata1, rule_code testdata2, rule_name testdata3, rule_score testdata4, rule_flagged testdata5, rule_accepted testdata6 ) and store in runtime variable",
        description = "This addon will Generate the Rule Response Without AcceptID and store it in a runtime variable",
        applicationType = ApplicationType.WEB)

public class GetRuleResponseWithoutAcceptID extends WebAction {
  ...
  public com.testsigma.sdk.Result execute() throws NoSuchElementException {
    ...
    try 
    {
       ...
       String Result = "{\"id\":" + var_rule_id + ",\"code\":\"" + var_rule_code + "\",\"name\":\"" + var_rule_name + "\",\"flagged\":" + var_rule_flagged + ",\"accepted\":" + var_rule_accepted + ",\"accept_ids\":[],\"score\":" + var_rule_score + "}";
